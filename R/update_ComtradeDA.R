...
#'   every `download_Comtrade()` data query.
#'   In other words, if new data becomes available and is documented in the
#'   [official Comtrade data availability file](https://comtrade.un.org/data/da),
...
#'  `data/`
#' @param file Name of file containing information on Comtrade's data availability;
#' default is `Comtrade_DataAvailability-<date stamp>`.
